...
public class MealTestData {
    private static final String[] ignoreFields = {"user"};
    public static final TestMatcher<Meal> MEAL_MATCHER = TestMatcher.usingIgnoringFieldsComparator(Meal.class, ignoreFields);
    public static final TestMatcher<MealTo> MEAL_TO_MATCHER = TestMatcher.usingIgnoringFieldsComparator(MealTo.class, ignoreFields);
